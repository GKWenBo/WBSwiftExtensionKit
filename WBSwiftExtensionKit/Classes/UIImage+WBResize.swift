...
extension UIImage {
    public enum wb_UIImageContentMode {
    ...
    /**
     ...
     - Returns A new image
     */
    public func wb_resize(_ size:CGSize, contentMode: wb_UIImageContentMode = .scaleToFill, quality: CGInterpolationQuality = .medium) -> UIImage? {
