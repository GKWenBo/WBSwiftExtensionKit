...
public extension UIImage {
    /**
     ...
     - returns: new image
     */
    func wb_gradientImageWithColors(_ gradientColors: [UIColor], blendMode: CGBlendMode = CGBlendMode.normal) -> UIImage {
     ...
     */
    @discardableResult
    class func wb_screenCaptureWithView(_ view: UIView, rect: CGRect) -> UIImage {
        let capture: UIImage
    ...
    /**
     ...
     - returns: UIImage
     */
    class func wb_imageWithColor(_ color: UIColor) -> UIImage {
    ...
    /**
     ...
     - returns: UIImage
     */
    func wb_roundWithCornerRadius(_ cornerRadius: CGFloat) -> UIImage {
    ...
    /**
     ...
     - returns: a new image
     */
    func wb_applyBorder(_ border:CGFloat, color:UIColor) -> UIImage? {
     ...
     */
    func wb_applyBlur(_ blurRadius:CGFloat, tintColor:UIColor?, saturationDeltaFactor:CGFloat, maskImage:UIImage? = nil) -> UIImage? {
